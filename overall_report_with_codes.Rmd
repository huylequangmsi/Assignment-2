...
Figure 1: Age and the attitude towards working mothers
...
Figure 2: Age and the attitude towards jobs for immigrants
...
Figure 2 illustrates that the attitude towards jobs for immigrants is quite stable across different ages. The line slightly goes down as age increases show that people tend to agree with the statement that when jobs are scarce, employers should give priority to national people over immigrants. 
...
All in all, older people, males and people with lower educational level tend to be less opened to working mothers and immigrants.
